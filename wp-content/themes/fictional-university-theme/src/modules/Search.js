      ...
      this.resultsDiv.innerHTML = `
        <div class="row">
          <div class="one-third">
            ...
            ${results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>No search results</p>'}
          ...
          <div class="one-third">
            ...
            ${results.programs.map(item => `<li>
              <a href="${item.permalink}">${item.title}</a></li>`).join('')}
          ...
          <div class="one-third">
            ...
            `<p>No event match that search. <a href="${universityData.root_url}/events">View all events.</a></p>`}
